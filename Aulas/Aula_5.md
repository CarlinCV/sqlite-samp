Se não souber de nenhuma função SQLite e para o que elas servem, recomendo que leia a [Aula 4](Aulas/Aula_4.md) onde foi explicado sobre todas as funções do SQLite.
...
# Aulas
- [Aula 5](Aulas/Aula_5.md) (Atual)
- [Aula 6](Aulas/Aula_6.md) (Próximo)
