Antes de começar a ler, leia primeiro [Insert](https://github.com/CarlinCV/sqlite-tutorial/Extra/insert.md) para compreender o contexto do que estiver escrito abaixo e não se perder.
