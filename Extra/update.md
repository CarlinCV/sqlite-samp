...
```
Sobre os parâmetros, se você não sabe, leia [insert](https://github.com/CarlinCV/sqlite-tutorial/Extra/insert.md) e também [select](https://github.com/CarlinCV/sqlite-tutorial/Extra/select.md) que irá compreender.
